...
const CartProductItem = (props) => {
    console.log(props)
    const[updateditems,seUpdatedtItems] = useState({Id: props.id,Name:props.name,Amount:props.amount,Srcpath:props.srcpathh});
    ...
    const passremoveitem = () => {
        ...
        seUpdatedtItems({Id: props.id,Name:props.name,Amount:props.amount,Srcpath:props.srcpathh});
    }
    ...
    return (
        <div className='cartproductItemcont'>
            <div className='carproditemimg'><img src={updateditems.Srcpath}></img></div>
            <div className='cartproddetails'>
                ...
                <button className='cartprodremovebutontxt' onClick={passremoveitem}>
                    <span><MdOutlineDelete size="18px" color="#C14086"/></span>
                    <span>Remove</span>
                </button>
            </div>
            <div className='cartproductaddbutton'>
                <div className='cartbuttonadd'> 
                    <button onClick={cartcountdeletehandler}><MdDelete/></button>
                    <span>{count}</span>
                    <button onClick={cartcountaddhandler}><GrAdd/></button>
                </div>
            </div>
