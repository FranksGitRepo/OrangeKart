...
const Cart = (props) => {
  const [arrayproductitems, setArrayproductitems] = useState(
    props.productitemsfrombody
  );
  ...
  const removeitemshandler = (x) => {
    ...
    for (let i = 0; i < updatedarray.length; i++) {
      if (updatedarray[i].Name == x) {
        updatedarray = props.productitemsfrombody.filter(
          (value) => x != value.Name
        );
      }
    }
          ...
          <div className="closebuttoncart">
            <div>
              <button className="exitbuttonincart" onClick={props.onCloseCart}>
                <span className="cartclosesign">
                  <CgClose size="22" color="#C14086" />
                </span>
          ...
          <div className="secndcartcont">
            <div className="scndcartshoptotal">
              <div className="secndimg">
                <img
                  srcset="https://www.instacart.com/image-server/88x88/www.instacart.com/assets/domains/warehouse/logo/279/0d43b5d2-9d07-4a30-a0ee-0e16d5922411.png, https://www.instacart.com/image-server/132x132/www.instacart.com/assets/domains/warehouse/logo/279/0d43b5d2-9d07-4a30-a0ee-0e16d5922411.png 1.5x, https://www.instacart.com/image-server/176x176/www.instacart.com/assets/domains/warehouse/logo/279/0d43b5d2-9d07-4a30-a0ee-0e16d5922411.png 2x, https://www.instacart.com/image-server/264x264/www.instacart.com/assets/domains/warehouse/logo/279/0d43b5d2-9d07-4a30-a0ee-0e16d5922411.png 3x, https://www.instacart.com/image-server/352x352/www.instacart.com/assets/domains/warehouse/logo/279/0d43b5d2-9d07-4a30-a0ee-0e16d5922411.png 4x"
                  alt=""
                  class="css-1vskc0q-Header"
                />
              </div>
            ...
            <div>
              {arrayproductitems.map((items) => (
                <CartProductItem
                  ontotalpricevaluehandler={ontotalpricevaluehandler}
                  id={items.Id}
                  name={items.Name}
                  amount={items.Amount}
                  srcpathh={items.Srcpath}
                  onremoveitems={removeitemshandler}
                />
              ))}
            </div>
          </div>
