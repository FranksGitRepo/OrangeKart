...
import { useUpdateURLParams } from "../../urlsearchParamsUpdate";
...
function Header(props) {
  ...
  return (
    <div className="header">
      {navstate || (
        <button className="harburgerbutton" onClick={showNavlinks}>
      ...
      <div className="toggle">
        <button
          ...
          onClick={deliveryactive}
          style={{ border: Deliveryborderchange }}
        >
          {" "}
          Delivery
        </button>
        <button
          className="togglebutton"
          onClick={pickupactive}
          style={{ border: pickupborderchange }}
        >
          Pickup
        </button>
      </div>
      ...
      {displaycart && (
        <Cart
          onCloseCart={discarthandler}
          productitemsfrombody={props.caritemsarray}
          getItemsremovedvalue={getitemsremovedhandler}
        />
      )}
    </div>
  );
